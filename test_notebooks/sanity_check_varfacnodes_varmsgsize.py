...
import pgmax.contrib.mpbp.mpbp_varfacnodes_unpadded as mpbp_varfacnodes_unpadded
...
map_message_dict = mpbp_varfacnodes_unpadded.run_mp_belief_prop_and_compute_map(

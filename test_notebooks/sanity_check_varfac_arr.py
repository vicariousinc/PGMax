...
import pgmax.contrib.mpbp.mpbp_varfacnode_array as mpbp_varfacnode_array
...
map_message_dict = mpbp_varfacnode_array.run_mp_belief_prop_and_compute_map(fg, var_evidence_dict, 1000, 0.5)

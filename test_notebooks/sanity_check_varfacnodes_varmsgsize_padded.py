...
import pgmax.contrib.mpbp.mpbp_varfacnodes_varmsgsize_padded as mpbp_varfacnodes_varmsgsize_padded
...
map_message_dict = (
    mpbp_varfacnodes_varmsgsize_padded.run_mp_belief_prop_and_compute_map(

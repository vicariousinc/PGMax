...
class BPContainer(NamedTuple):
    ...
    to_bp_state: Callable[..., BPState]
    get_beliefs: Callable[..., Any]


def BP(bp_state: BPState, temperature: float = 0.0) -> BPContainer:
    ...
    Returns:
        A BPContainer for belief propagation functions.
    """
